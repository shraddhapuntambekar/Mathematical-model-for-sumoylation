function dy = getrate_forfsolve_closed(y0_forfsolve,param,yini)
getnames;
ns=param.n_species;

e1tot = yini(ne10) + yini(nse10) ;
e2tot = yini(ne20) + yini(nse20)+yini(ne21) + yini(nse21)+yini(ne21senp)+yini(nsumoe21senp);
presumotot=yini(npresumo)+yini(npresumosenp)+yini(nsumo)+yini(nse10)+yini(nse20)+yini(ne21)+yini(nse21)+yini(nt11)+yini(nt11senp)+yini(ne21senp)+yini(nsumoe21senp);%+yini(nt21)+yini(nt21senp);
senptot=yini(nsenp)+yini(npresumosenp)+yini(nt11senp)+yini(ne21senp)+yini(nsumoe21senp); %+yini(nt21senp);
t10tot=yini(nt11)+yini(nt10)+yini(nt11senp);
t20tot=yini(nt21)+yini(nt20)+yini(nt21senp);
...
dy(ns+1)=e1tot - e10 - se10 ;
dy(ns+2)=e2tot - e20 - se20 - e21- se21- e21senp - sumoe21senp;
dy(ns+3)=presumotot  - presumo - presumosenp - sumo - se10 - se20 -e21 -se21 - t11  - t11senp  - e21senp -sumoe21senp ; %- t21senp - t21 ;
dy(ns+4)=senptot - senp - presumosenp - t11senp  - e21senp - sumoe21senp; %- t21senp;
dy(ns+5)=t10tot - t11- t10 - t11senp;
dy(ns+6)=t20tot - t21 - t20 - t21senp;
